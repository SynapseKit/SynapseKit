...
class WebScraperTool(BaseTool):
    ...
    def _clean_html(self, html: str, css_selector: str | None = None) -> str:
        ...
        # If CSS selector provided, extract only that content
        if css_selector:
    ...
    async def run(self, url: str = "", css_selector: str | None = None, **kwargs: Any) -> ToolResult:
        """Async version: fetch URL and return clean text."""
        try:
            import httpx
        except ImportError:
    ...
    def run_sync(self, url: str = "", css_selector: str | None = None, **kwargs: Any) -> ToolResult:
        """Sync version: fetch URL and return clean text."""
        try:
            import httpx
        except ImportError:
            raise ImportError("httpx required: pip install synapsekit[web]") from None
