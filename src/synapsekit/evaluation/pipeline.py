...
class EvaluationPipeline:
    ...
    async def evaluate(
        ...
        scores = {m.name: r.score for m, r in zip(self._metrics, metric_results, strict=False)}
        details = {m.name: r for m, r in zip(self._metrics, metric_results, strict=False)}
