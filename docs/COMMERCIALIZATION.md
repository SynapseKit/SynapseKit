...
- 1,327 tests passing, CI pipeline, linting, type checking
- 23 LLM providers, 14 loaders, 5 vector stores, 38 tools
...
**Pivot point: v1.4.0** — v1.4.0 and below is fully open source. v1.5.0+ introduces commercial products built on top of the open core.
...
|---|---|---|---|
| **Done** | `synapsekit serve` + cost tracking + eval CLI + compliance primitives | v1.2.0–v1.4.0 | Open source (adoption) |
