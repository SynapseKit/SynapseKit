...
- **WeatherTool** — current weather and 5-day forecast via OpenWeatherMap; actions: current, forecast; stdlib urllib only, async-safe via run_in_executor; auth via OPENWEATHERMAP_API_KEY env var; closes #383
